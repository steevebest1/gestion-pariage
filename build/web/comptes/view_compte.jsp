...
<div class="wrapper container-fluid">
    <div class="container mt-1 mb-1">
        <form method="POST" action="${pageContext.request.contextPath}/ComptesServlet?operation=add">
            <h3>Mon COMPTE</h3>
            <div><a href="view_compte_par.jsp"><span class="btn btn-primary">Mes pariages</span></a><a href="view_compte_p.jsp"><span class="ms-3 btn btn-primary">Mes paiements</span></a></div>>
