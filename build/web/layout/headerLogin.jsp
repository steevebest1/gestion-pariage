...
<div class="container-fluid bg-dark ms-0 me-0">
    ...
    <div class="container">
      <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
        ...
        <div class="text-end">
            <!--<a href="comptes/add_compte.jsp"><button type="button" class="btn me-2 text-light" style="background-color:firebrick">Se connecter</button></a>-->
          <a href="comptes/add_compte.jsp"><button type="button" class="btn text-light" style="background-color:firebrick">Inscription</button></a>
        </div>
      </div>
    </div>
  </header>
